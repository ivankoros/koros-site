...
const PunPun = (props: DockProps) => {
    ...
    <g id="bb4ffcf5-1f41-45f3-ad08-dfc751bc5ef0" data-name="Layer 2">
        ...
        <path fill="#231f20" d="M227 116.5a82.48 82.48 0 0 1-11.77 54.5 78.75 78.75 0 0 1-9.79 12.69c-2.05 2.17 1.22 5.46 3.28 3.28a87.43 87.43 0 0 0 23.47-54.43 84.78 84.78 0 0 0-.74-17.22 2.33 2.33 0 0 0-2.86-1.62 2.37 2.37 0 0 0-1.59 2.8Z"/>
        <path fill="#231f20" d="M207.47 182.69a45 45 0 0 0-14.13 2.84 2.37 2.37 0 0 0-1.62 2.85 2.35 2.35 0 0 0 2.86 1.62 43.32 43.32 0 0 1 6.51-1.9l1.61-.3.87-.14a1.74 1.74 0 0 1 .39 0c1.16-.14 2.33-.23 3.51-.28a2.32 2.32 0 0 0 0-4.64Z"/>
        <path fill="#231f20" d="M204.87 184.77a6.27 6.27 0 0 1-.73 1c.11-.11.33-.41.09-.12l-.2.24-.42.48c-.28.29-.56.57-.86.84l-.48.42-.24.2c-.31.25.34-.26.11-.09a16.66 16.66 0 0 1-2.09 1.31l-.57.27-.23.11c.63-.31.23-.1.08 0-.39.15-.79.29-1.2.41a2.32 2.32 0 1 0 1.24 4.47 17.1 17.1 0 0 0 9.51-7.2 2.34 2.34 0 0 0-.84-3.17 2.37 2.37 0 0 0-3.17.83Z"/>
        <path fill="#231f20" d="M204.86 186.46c-.1-.7 0 .06 0 .2v3.63q.06-.48 0-.21a20.17 20.17 0 0 1-.48 2.18c-.11.37-.23.74-.36 1.1a2 2 0 0 0-.18.46c.13-.3.14-.33 0-.1l-.14.3a2.53 2.53 0 0 0-.23 1.79 2.39 2.39 0 0 0 1.06 1.39 2.36 2.36 0 0 0 3.18-.83 19.15 19.15 0 0 0 1.61-5.22 20.32 20.32 0 0 0 0-5.93 2.26 2.26 0 0 0-1.06-1.38 2.31 2.31 0 0 0-3.18.83 2.75 2.75 0 0 0-.23 1.79ZM265.73 131a82.51 82.51 0 0 1-4.16 55.78 81.63 81.63 0 0 1-8.19 14.18 2.35 2.35 0 0 0 .84 3.18 2.37 2.37 0 0 0 3.17-.84 87 87 0 0 0 15.78-56.6 84.59 84.59 0 0 0-3-16.93c-.81-2.87-5.29-1.65-4.47 1.23Z"/>
        <path fill="#231f20" d="M255.12 199.54a44.83 44.83 0 0 0-13.57 4.79 2.33 2.33 0 0 0-.83 3.17 2.36 2.36 0 0 0 3.17.84c1-.57 2.08-1.09 3.16-1.56l.31-.14.87-.35c.51-.2 1-.39 1.54-.57a42.67 42.67 0 0 1 6.58-1.7 2.34 2.34 0 0 0 1.62-2.86 2.37 2.37 0 0 0-2.85-1.62Z"/>
        <path fill="#231f20" d="M253.27 201.61a15.22 15.22 0 0 1-1.67 2.77l.36-.46a15.45 15.45 0 0 1-2.68 2.68l.47-.37a14.65 14.65 0 0 1-2.87 1.72 2.33 2.33 0 0 0-1.07 1.39 2.43 2.43 0 0 0 .23 1.79 2.35 2.35 0 0 0 1.39 1.06 2.65 2.65 0 0 0 1.79-.23 16.52 16.52 0 0 0 8-8 2.54 2.54 0 0 0 .24-1.79 2.4 2.4 0 0 0-1.07-1.39 2.35 2.35 0 0 0-3.17.83Z"/>
        <path fill="#231f20" d="M253.24 203.27a9.92 9.92 0 0 1 .48 2.21v1.91c0 .38 0 .75-.05 1.13 0 .17 0 .35-.05.52 0 .49.08-.46 0 .16a16.51 16.51 0 0 1-.53 2.29 2.34 2.34 0 0 0 1.62 2.85 2.36 2.36 0 0 0 2.86-1.62 19.11 19.11 0 0 0 .09-10.68 2.32 2.32 0 0 0-4.48 1.23Z"/>
        ...
        <path fill="#f2f8ee" d="m195.46 29.32 32.22 24.51 8.13-27.81-40.35 3.3z" opacity=".95"/>
        ...
        <path fill="#adb3ae" d="m23.64 158.59-.57 7.21c-.14 1.82 0 4.26-1.65 5.47a3.41 3.41 0 0 1-4.26-.08 3.52 3.52 0 0 1-.59-4.31.72.72 0 0 0-1.24-.73 4.82 4.82 0 0 0 3.27 7.21 5 5 0 0 0 4.29-1.48c1.32-1.43 1.41-3.44 1.56-5.27l.63-8c.07-.93-1.37-.92-1.44 0Z"/>
        <path fill="#adb3ae" d="m15.21 166.32-3.72 6a.71.71 0 0 0 .18.92.74.74 0 0 0 .95-.05l3.11-2.53a.72.72 0 0 0 0-1 .73.73 0 0 0-1 0l-3.12 2.53 1.13.87 3.72-6c.49-.79-.76-1.51-1.24-.72Z"/>
        </g>
    </g>
    </svg>
)
